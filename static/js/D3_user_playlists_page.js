...
d3.json('/playlists.json').then(function (data) {
    ...
    node.filter(d => !String(d.icon).includes('image'))
        .append('text')
    ...
    */
    ...
    infoBox.on('click', (infoBoxNode) => {
        const payload = { playlistId: infoBoxNode.name };
        function sendData(data) {
            ...
            // Define what happens on successful data submission. I had to write this code 
            //to manually redirect to songspage because for some reason, Flask was not successfully
            //redirecting to the page. However, data was successfully being sent to the Flask and querying
            //database. All the backend part was doing well, with the exception of the page redirection.
            XHR.addEventListener('load', function (event) {
                window.location.assign('/songspage');
            });
